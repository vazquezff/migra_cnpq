...
# Footer personalizado com os logos da UNEMAT e CNPq
logo_unemat_base64 = get_base64_encoded_image('unemat-logo.png')
logo_cnpq_base64 = get_base64_encoded_image('CNPq_v2017_rgb.png')
...
st.markdown(
    ...
    ">
        <div style="display: flex; align-items: center;">
            <img src="data:image/png;base64,{logo_unemat_base64}" 
        ...
        <img src="data:image/png;base64,{logo_cnpq_base64}" 
             style="height: 30px; margin-left: 20px; filter: brightness(0) invert(1);">
    </div>
    ''',
    unsafe_allow_html=True
)